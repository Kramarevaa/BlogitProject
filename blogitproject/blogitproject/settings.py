...
SECRET_KEY = 'b%6pth9_r&x=s(8hoz#to-$2+rzj06l%0%$!uowyvo^1c)-!=%'
...
DATETIME_INPUT_FORMATS = (
    '%d.%m.%y %H:%M', '%d.%m.%y %H:%M:%S', '%d.%m.%Y %H:%M', '%d.%m.%Y %H:%M:%S', '%Y-%m-%d %H:%M:%S', '%Y-%m-%d %H:%M:%S.%f', '%Y-%m-%d%H:%M', '%Y-%m-%d', '%m/%d/%Y %H:%M:%S', '%m/%d/%Y %H:%M:%S.%f', '%m/%d/%Y %H:%M', '%m/%d/%Y', '%m/%d/%y %H:%M:%S', 
